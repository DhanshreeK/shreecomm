class ReportPdf < Prawn::Document
  def initialize(engineer_copys,page_size)
    ...
    text "Bill No: #{@engineer_detail.bill_no} Call For Status: #{GeneralSetting.last.phone_no}",:style => :bold_italic,:inline_format => true,size: 10
  ...
  def customer_detail
      data = [["Customer Name", @engineer_detail.custome_name, "Request Date",@engineer_detail.date, "Address", @engineer_detail.address],
                 ...
                 ["Repair Description", @engineer_detail.repair_description, "Condition Code", @engineer_detail.condition_code, "Symptom Code", @engineer_detail.symtom_code],
